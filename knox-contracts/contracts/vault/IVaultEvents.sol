...
interface IVaultEvents {
     ...
     * @param timeToMaturity64x64 time to maturity as a 64x64 fixed point number
     ...
     * @param epoch epoch id
     * @param netIncome net income generated during the epoch
    ...
    /**
     * @notice emitted when the withdrawal fee is collected
     * @param epoch epoch id
     * @param feeInCollateral fee from net income, denominated in the collateral asset
     * @param feeInShortContracts fee from net income, denominated in the short contracts
     */
     ...
     * @param epoch epoch id
     * @param oldWithdrawalFee previous withdrawal fee
